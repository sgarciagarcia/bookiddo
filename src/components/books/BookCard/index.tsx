  ...
  useEffect(
    () => {
      const loadBooks = async () => {
        ...
        setThisBook(
          recs.books.find((book: { isbn: string }) => book.isbn === isbn)
        );
        // setKidData(recs)
      };
      loadBooks();
    ...
    <div className="bg-shape wrapper centered">
      <div className="cover-wrapper">
        ...
        <div className="button-wrapper">
          <a href={`${thisBook.amazon}`} target="_blank" rel="noreferrer">
        ...
        {thisBook.price !== "" && thisBook.price !== "0.00" && (
          <h3>$ {thisBook.price}</h3>
        )}
      </div>
